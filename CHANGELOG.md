...
- Non-production deployments are excluded from search indexing (robots.txt + noindex meta), and dev emails are visibly differentiated (env-driven sender name, `[DEV]` subject prefix, site-URL-aware logo)
