  ...
  const generateVehicleSchema = () => {
    ...
    return {
      ...
      vehicleEngine: {
        ...
        fuelType: vehicle.fuelType || "Petrol",
        engineDisplacement: vehicle.engineCapacity
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`Închiriază ${vehicleName} în Cluj-Napoca cu Rent'n Go. ${vehicle.seats} locuri, ${vehicle.fuelType || "Petrol"}, ${vehicle.transmission || "Manual"}. Rezervare online rapidă pentru masini de inchiriat Cluj.`}
        />
        <meta
          name="keywords"
