...
export const metadata: Metadata = {
  ...
  description: "Masini de inchiriat Cluj-Napoca cu Rent'n Go. Car rentals Cluj-Napoca cu prețuri competitive. Servicii profesionale de închiriere auto în Cluj-Napoca.",
  keywords: ["masini de inchiriat Cluj-Napoca", "car rentals Cluj-Napoca", "rent car Cluj", "închiriere auto Cluj", "rental cars Cluj-Napoca", "închiriat mașini Cluj"],
  ...
  twitter: {
    ...
    title: 'Rent\'n Go Cluj-Napoca | Masini de Inchiriat',
    description: 'Masini de inchiriat Cluj-Napoca cu Rent\'n Go. Car rentals Cluj-Napoca cu servicii de calitate.',
    images: ['/logo.png'],
  },
  icons: {
