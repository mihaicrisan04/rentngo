...
export function AdminSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible="icon" variant="inset" {...props}>
      ...
      <SidebarRail className="after:left-[calc(50%+6px)] after:inset-y-auto after:top-1/2 after:h-4/5 after:-translate-y-1/2 after:rounded-full hover:after:bg-transparent hover:after:bg-gradient-to-b hover:after:from-transparent hover:after:via-sidebar-border hover:after:to-transparent" />
    </Sidebar>
  )
}
