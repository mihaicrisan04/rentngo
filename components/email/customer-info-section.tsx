  ...
  return (
    <Section className="px-[16px] py-[12px]">
      ...
      <Row className="mb-[12px]">
        <Column>
          <Text className="text-[14px] font-semibold text-gray-600 m-0">{labels?.name ?? 'Customer Name:'}</Text>
      ...
      <Row className="mb-[12px]">
        <Column>
          <Text className="text-[14px] font-semibold text-gray-600 m-0">{labels?.email ?? 'Email:'}</Text>
      ...
      <Row className="mb-[12px]">
        <Column className="w-1/2 pr-[8px]">
          <Text className="text-[14px] font-semibold text-gray-600 m-0">{labels?.phone ?? 'Phone:'}</Text>
        ...
        {customerInfo.flightNumber && (
          <Column className="w-1/2 pl-[8px]">
            <Text className="text-[14px] font-semibold text-gray-600 m-0">{labels?.flightNumber ?? 'Flight Number:'}</Text>
      ...
      {customerInfo.message && (
        <Row className="mb-[12px]">
          <Column>
            <Text className="text-[14px] font-semibold text-gray-600 m-0">{labels?.message ?? 'Customer Message:'}</Text>
