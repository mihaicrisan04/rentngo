...
export function VehicleSearchFilterForm({
  ...
  const setDeliveryLocation = (value: string) => updateSearchField('deliveryLocation', value);
  const setRestitutionLocation = (value: string) => updateSearchField('restitutionLocation', value);
  const setPickupDateState = (value: Date | undefined) => updateSearchField('pickupDate', value);
  const setPickupTime = (value: string | null) => updateSearchField('pickupTime', value);
  const setReturnDateState = (value: Date | undefined) => updateSearchField('returnDate', value);
  const setReturnTime = (value: string | null) => updateSearchField('returnTime', value);
